...
embargo, en lugar de eso, nos referiremos a lo que Grupo Nielsen Norman Llamadas Flujos de alambre como flujos de
usuario.
...
Figma es una herramienta de diseño que está disponible como aplicación web y de escritorio. Su característica más
destacada es su soporte para la colaboración en tiempo real, lo que permite a los miembros del equipo trabajar en el
mismo wireframe, maqueta o prototipo simultáneamente. A partir de 2022, Figma ha sido adquirida por Adobe y domina el
mercado de herramientas de diseño.

Figma también tiene complementos de la comunidad disponibles para funciones adicionales, como Iconificar, que recopila
...
* Plugins de la comunidad de Figma
* Galería de plantillas de Figma

Las variables de Figma se dieron a conocer durante Configuración 2023 (la conferencia anual de usuarios de Figma), y las
...
jugable de Flappy Bird usando variables de Figma.

Exporta tus diseños como un archivo al enviarlos. .figLas instrucciones se pueden encontrar aquí en la parte inferior.

Además de Figma, aquí hay algunas otras herramientas entre las que puede elegir:

* Invision: Su plan gratuito permite a los usuarios tener un prototipo con pantallas ilimitadas y colaboradores
  ilimitados durante un período de tiempo ilimitado.
* Bosquejo: Un estándar de la industria, pero no es gratuito y solo está disponible en macOS.
* Adobe XD: Solíamos recomendar Adobe XD como alternativa, pero desde que Adobe adquirió Figma, la aplicación está
  descontinuada.
* PowerPoint.
* Papel y lápiz para bocetos alámbricos.

Sea cual sea la herramienta que elija, tiene que ser capaz de producir un prototipo que cumpla con todos los requisitos
del encargo. En particular, el prototipo final debe ser interactivo y demostrar los flujos de usuario a través de la
...
::callout{icon="ph:flag-checkered-duotone"}
**Hito 0c (No calificado):** Lectura completa Elly: Buscador de habitaciones/compañeros de piso móvil aplicación. Este
estudio de caso ayuda a para que comprenda la importancia del proceso de diseño centrado en el usuario y por qué La
...
elijas un usuario objetivo que esté disponible en abundancia a tu alrededor, por ejemplo, tus compañeros de NUS. De esta
manera, puede realizar fácilmente sus pruebas de usuario.
...
Enumere lo anterior en una tarjeta de persona de usuario. Una persona es una representación ficticia de un usuario ideal
...
_**Fuente:** Meetup: Un estudio de caso de usabilidad_
...
En general, recuerde que está construyendo un Producto Mínimo Viable (MVP). El objetivo no es crear un conjunto completo
de características del producto; En cambio, el número de características debe ser suficiente para probar su idea y
...
un vistazo a su Cronología del producto.
...
su enfoque en los elementos esenciales de la mensajería. Hilos, el "asesino de Twitter" de Meta, vio más de 100 millones
...
* ¿Cómo se ejecutará su producto? Estas son algunas preguntas orientadoras que pueden ayudarte a responder esta
  pregunta:

2. ¿Qué recursos o datos necesita tu producto?
...
* Usabilidad 101: Introducción a la usabilidad
...
* Mobbin: Un sitio web que muestra las diversas pantallas que se encuentran dentro de las aplicaciones móviles y web
  populares que es muy popular entre la comunidad de diseño. Está fundada por ex alumnos de la Escuela de Computación
  Jiho Lim y Liau Jian Jie (CS3216 AY2019/20).
* Flujos de página: Cubre los flujos de usuarios, las pantallas y los correos electrónicos en varios dispositivos.
  Generosa cantidad de contenido gratuito.
* Orígenes de la interfaz de usuario: Otra fuente de inspiración para el flujo de la interfaz de usuario que se centra
  en las aplicaciones móviles e incluye grabaciones de los recorridos de los usuarios finales (de pago).

Recursos de diseño específicos de la plataforma:

* Herramientas de diseño de materiales: Centro de recursos oficial de Material Design, el sistema de diseño de código
  abierto de Google. Útil si quieres seguir un tema de diseño de materiales.
* Recursos de diseño de Apple: Activos y herramientas para diseñar para dispositivos Apple.

Otros buenos recursos para inspirarse en el diseño son Behance y Regate. Son sitios web utilizados por los diseñadores
...
Las estructuras alámbricas son Diseños de "baja fidelidad". Esto significa que no deben contener ningún elemento
específico del diseño, como colores, fuente o detalles innecesarios como contenido e imágenes generados por el usuario.
Estos distraen de los aspectos que son más importantes en esta etapa actual de desarrollo y ralentizan la velocidad a la
que se producen. En su lugar, concéntrese en el tamaño y la posición relativos de los elementos, los elementos clave de
la interfaz de usuario y las interacciones, como los elementos en los que se puede hacer clic o tocar, arrastrar, etc.

_**Fuente: https://www.flickr.com/photos/anthonyarmendariz/4448219885/in/pool-1070674@N20/**_
...
coloridos que pueden contribuir a la estética de su Estructura alámbrica. Sin embargo, el objetivo de los wireframes es
...
_**Fuente: https://www.flickr.com/photos/mockupbuilder/12987528713/in/pool-ilovewireframes/**_
...
el usuario interactúa con ellos. No digas nada durante todo el proceso. Si los usuarios se pierden o se confunden, que
se pierdan o se confundan. Solo pídales lo que están pensando si parece que no están pensando en voz alta. Si se
...
::callout{icon="ph:flag-checkered-duotone" color="amber"}
**Hito 7: Revise** Si siente que aún no está listo para esta etapa, puede realizar más Rondas de iteración de diseño y
pruebas de usuario con wireframes. Asegúrese de Incluya los resultados y asigne un nombre adecuado a las carpetas.
::

::alert{icon="i-ph-check-circle" color="amber"}
A **default** alert with `code` and a [link](/).
::
...
* Haz videos promocionales. Ver videos anteriores del proyecto final de CS3216 aquí.
...
::callout{icon="ph:flag-checkered-duotone" color="amber"}
**Hito 10: Diseñe** una pequeña campaña de marketing para su aplicación. Explique qué marketing canales que usarías y
